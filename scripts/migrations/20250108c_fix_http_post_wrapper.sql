-- 20250108c_fix_http_post_wrapper.sql
-- Purpose: Fix HTTP post call to use proper net.http_post wrapper function

-- Update function to use net.http_post wrapper instead of extensions.net.http_post
...
BEGIN
    ...
    IF TG_OP = 'INSERT' THEN
        ...
        -- Send DM to each middle manager using wrapper function
...
COMMENT ON FUNCTION public.notify_middle_manager_on_insert() IS 'Send Slack DM to middle_manager when new purchase_request is inserted (using net.http_post wrapper).';